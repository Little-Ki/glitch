...
namespace ct::menu::hook {
	...
	using PresentFn = HRESULT(__stdcall*)(IDXGISwapChain* Self, UINT SyncInterval, UINT Flags);

	static PresentFn oPresent = nullptr;
	static PresentFn tPresent = nullptr;

	static HRESULT __stdcall hkPresent(IDXGISwapChain* self, UINT SyncInterval, UINT Flags)
	{
		...
		return tPresent(self, SyncInterval, Flags);
	}
